...
// DeleteEvent provides a mock function with given fields: ctx, id, timesheetId
func (_m *Adapter) DeleteEvent(ctx context.Context, id string, timesheetId string) error {
	ret := _m.Called(ctx, id, timesheetId)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, id, timesheetId)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Adapter) SearchEvents(ctx context.Context, id string) (bool, *domain.SearchResponse, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Adapter) SearchTimetable(ctx context.Context, rq *domain.SearchTimesheetRequest) (bool, *domain.SearchTimesheetsResponse, error) {
