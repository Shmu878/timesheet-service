...
func (_m *EventStorage) DeleteEvent(ctx context.Context, id string, timesheetId string) error {
...
func (_m *EventStorage) SearchEvents(ctx context.Context, id string) (bool, *domain.SearchResponse, error) {
	ret := _m.Called(ctx, id)
